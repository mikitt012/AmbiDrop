...
if __name__ == "__main__":
    ...
    data_root = "/Users/mikitatarjitzky/Documents/AmbiDrop Code/AmbiDrop/datasets/nose_bridge_experiment/dataset"
    ...
    for scenario in scenarios:
        ...
        if simulated_steering:
            steering_name = "simV"
            steer_path = "/Users/mikitatarjitzky/Documents/AmbiDrop Code/AmbiDrop/datasets/experiment_full_anm/steering/Aria on rigid sphere (simulated).mat"
        ...
        for t in range(0,1):
            ...
            if smallnet:
                if AmbiDrop:
                    ...
                    checkpoint_path = "/Users/mikitatarjitzky/Documents/AmbiDrop Code/AmbiDrop/checkpoints/checkpoint_size_11074.pt"
                else:
                    net = FT_JNF(
                        input_dim=ch_num,
                        hidden1_dim=64,
...
#runai-bgu submit python -n aria-test-nosebridge-11074 -c 20 -m 40G -g 0.5 --conda venv -- "python /Users/mikitatarjitzky/Documents/AmbiDrop Code/AmbiDrop/test_aria_glasses.py"
